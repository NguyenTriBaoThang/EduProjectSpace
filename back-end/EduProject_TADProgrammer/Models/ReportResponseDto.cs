...
namespace EduProject_TADProgrammer.Models
{
    ...
    {
        public ReportSummaryDto Summary { get; set; } // Ghi chú: Thống kê tổng quan
        public List<StudentReportDto> Students { get; set; } // Ghi chú: Danh sách sinh viên
        public List<ProjectReportDto> Projects { get; set; } // Ghi chú: Danh sách đề tài
        public List<LecturerReportDto> Lecturers { get; set; } // Ghi chú: Danh sách giảng viên
    }
}