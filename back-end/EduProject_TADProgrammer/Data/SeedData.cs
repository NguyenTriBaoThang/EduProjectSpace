    ...
    public static class SeedData
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().HasData(
                // Admin
                new User { Id = 1, Username = "admin", Password = hashedPassword, Email = "admin@hutech.edu.vn", FullName = "Quản trị viên", RoleId = 1, FailedLoginAttempts = 0, Locked = false, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
                // Trưởng bộ môn
                new User { Id = 2, Username = "head1", Password = hashedPassword, Email = "head1@hutech.edu.vn", FullName = "Nguyễn Văn Hùng", RoleId = 4, FailedLoginAttempts = 0, Locked = false, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
                new User { Id = 3, Username = "head2", Password = hashedPassword, Email = "head2@hutech.edu.vn", FullName = "Trần Thị Lan", RoleId = 4, FailedLoginAttempts = 0, Locked = false, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
                // Giảng viên hướng dẫn
                new User { Id = 4, Username = "lecturer1", Password = hashedPassword, Email = "lecturer1@hutech.edu.vn", FullName = "Lê Văn Nam", RoleId = 2, FailedLoginAttempts = 0, Locked = false, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
                new User { Id = 5, Username = "lecturer2", Password = hashedPassword, Email = "lecturer2@hutech.edu.vn", FullName = "Phạm Thị Mai", RoleId = 2, FailedLoginAttempts = 0, Locked = false, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
                new User { Id = 6, Username = "lecturer3", Password = hashedPassword, Email = "lecturer3@hutech.edu.vn", FullName = "Hoàng Văn Tùng", RoleId = 2, FailedLoginAttempts = 0, Locked = false, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
                // Sinh viên
                new User { Id = 7, Username = "student1", Password = hashedPassword, Email = "student1@hutech.edu.vn", FullName = "Nguyễn Tri Bão Thắng", RoleId = 3, FailedLoginAttempts = 0, Locked = false, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
                new User { Id = 8, Username = "student2", Password = hashedPassword, Email = "student2@hutech.edu.vn", FullName = "Trần Văn Bình", RoleId = 3, FailedLoginAttempts = 0, Locked = false, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
                new User { Id = 9, Username = "student3", Password = hashedPassword, Email = "student3@hutech.edu.vn", FullName = "Lê Thị Cẩm", RoleId = 3, FailedLoginAttempts = 0, Locked = false, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
                new User { Id = 10, Username = "student4", Password = hashedPassword, Email = "student4@hutech.edu.vn", FullName = "Phạm Văn Đức", RoleId = 3, FailedLoginAttempts = 0, Locked = false, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
                new User { Id = 11, Username = "student5", Password = hashedPassword, Email = "student5@hutech.edu.vn", FullName = "Hoàng Thị Em", RoleId = 3, FailedLoginAttempts = 0, Locked = false, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow }
            );
