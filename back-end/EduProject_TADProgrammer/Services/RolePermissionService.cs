...
namespace EduProject_TADProgrammer.Services
{
    public class RolePermissionService
    {
        ...
        public async Task<List<RolePermissionDto>> GetAllPermissions()
        {
        ...
        public async System.Threading.Tasks.Task UpdatePermission(long roleId, RolePermissionDto request)
        {
