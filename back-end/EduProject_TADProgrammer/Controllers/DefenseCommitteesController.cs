...
namespace EduProject_TADProgrammer.Controllers
{
    ...
    public class DefenseCommitteesController : ControllerBase
    {
        ...
        public DefenseCommitteesController(DefenseCommitteeService service)
        {
            _service = service;
        }
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<DefenseCommitteeDto>>> GetCommittees()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<DefenseCommitteeDto>> GetCommittee(long id)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<DefenseCommitteeDto>> CreateCommittee([FromBody] CreateDefenseCommitteeRequest request)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateCommittee(long id, [FromBody] UpdateDefenseCommitteeRequest request)
        {
            try
            {
