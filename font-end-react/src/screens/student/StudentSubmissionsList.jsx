...
import setup from "./StudentSubmissionsList.controller";
import pages from "../../pageManifest.json";
const definition = pages.find(page => page.path === "/student/submissions-list");
export default function StudentSubmissionsList() {
  const page = usePageController(setup, definition);
  return <div ref={page.root} className="page-frame" data-page="/student/submissions-list">
  ...
  <nav className="navbar navbar-expand-lg px-3">
    ...
    <div className="ms-auto d-flex align-items-center">
      <input type="text" className="search-box me-3" placeholder={"🔍 Tìm kiếm..."} id="searchInput" />
    ...
    <nav className="breadcrumb-container">
      <ol className="breadcrumb">
        ...
        <li className="breadcrumb-item active">
          <i className="bi bi-list-ul"></i>{" Danh sách học phần\n                    "}</li>
      </ol>
    </nav>
    <div className="table-container">

      <div className="table-header d-flex gap-2">
        <input type="text" id="searchInput" className="form-control" placeholder={"🔍 Tìm kiếm học phần..."} onKeyUp={event => page.invoke("event2", event)} />
