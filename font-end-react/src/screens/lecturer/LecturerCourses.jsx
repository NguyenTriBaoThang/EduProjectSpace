...
import setup from "./LecturerCourses.controller";
import pages from "../../pageManifest.json";
const definition = pages.find(page => page.path === "/lecturer/courses");
export default function LecturerCourses() {
  const page = usePageController(setup, definition);
  return <div ref={page.root} className="page-frame" data-page="/lecturer/courses">
  ...
  <div className="container mt-4">
    ...
    <nav className="breadcrumb-container">
      <ol className="breadcrumb">
        ...
        <li className="breadcrumb-item active"><i className="bi bi-book"></i>{" Quản lý học phần"}</li>
      </ol>
    </nav>
