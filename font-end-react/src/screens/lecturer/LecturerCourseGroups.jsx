...
import setup from "./LecturerCourseGroups.controller";
import pages from "../../pageManifest.json";
const definition = pages.find(page => page.path === "/lecturer/course-groups");
export default function LecturerCourseGroups() {
  const page = usePageController(setup, definition);
  return <div ref={page.root} className="page-frame" data-page="/lecturer/course-groups">
  ...
  <div className="container mt-4">
    <div className="d-flex justify-content-between align-items-center mb-4">
      <h2 className="fw-bold text-primary">{"👥 Danh sách học phần cần chia nhóm"}</h2>
    ...
    <nav className="breadcrumb-container">
      <ol className="breadcrumb">
        ...
        <li className="breadcrumb-item active"><i className="bi bi-people"></i>{" Danh sách môn cần chia nhóm"}</li>
      </ol>
    </nav>
